 ...
 * 取り込み元
 *    ライブラリ名：     seasar2
 *    クラス名：         org.seasar.framework.util.StringUtil
 *    ソースリポジトリ： https://github.com/seasarorg/seasar2/blob/master/seasar2/s2-framework/src/main/java/org/seasar/framework/util/StringUtil.java
 *
 * 上記ファイルを取り込み、修正を加えた。
 *
...
public class StringUtil {
    ...
    /**
     * 文字列が<code>null</code>でも空文字列でもなければ<code>true</code>を返却する。
     *
     * @param text
     *            文字列
    ...
    /**
     * ケースインセンシティブで特定の文字列で開始されているかどうかを返却する。
     *
     * @param text
     *            テキスト
     * @param fragment
    ...
    /**
     * 文字列同士が等しいかどうか返却する。どちらもnullの場合は、<code>true</code>を返却する。
     *
     * @param target1
     *            文字列1
     * @param target2
    ...
    /**
     * ケースインセンシティブで文字列同士が等しいかどうか返却する。どちらもnullの場合は、<code>true</code>を返却する。
     *
     * @param target1
     *            文字列1
     * @param target2
